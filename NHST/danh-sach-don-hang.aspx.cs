                        ...
                        if (item.OrderType == 3)
                        {
                            ...
                            else
                            {
                                if (item.Status == 0)
                                {
                                    ...
                                    html.Append("    <a href=\"javascript:;\" onclick=\"RemoveOrder('" + item.ID + "', $(this))\" data-position=\"top\"><i class=\"material-icons\">delete</i>Xóa đơn</a>");
                                    //html.Append("    <a href=\"javascript:;\" onclick=\"depositOrder80('" + item.ID + "', $(this))\" data-position=\"top\"><i class=\"material-icons\">attach_money</i><span>Đặt cọc 90%</span></a>");
                                }
            ...
            if (obj_user != null)
            {
                ...
                if (OID > 0)
                {
                    ...
                    if (mo != null)
                    {
                        ...
                        if (kq != null)
                        {
                            PJUtils.ShowMessageBoxSwAlert("Xóa đơn hàng thành công.", "s", true, Page);
                        }
                        else
                        {
                            ...
                            if (custDeposit > 0)
                            {
                                if (userwallet >= custDeposit)
                                {
                                    ...
                                    if (st == 1)
                                    {
                                        ...
                                        //}
                                        //else if (pricevnd > 0 && pricevnd < 2000000)
                                        //{
                                        //    phantramdichvu = 3;
                                        //}
                                        //else if (pricevnd > 2000000 && pricevnd < 5000000)
                                        //{
                                        //    phantramdichvu = 1.9;
                                        //}
                                        //else
                                ...
                                if (userwallet >= custDeposit)
                                {
                                    ...
                                    if (st == 1)
                                    {
                                        ...
                                        if (setNoti != null)
                                        {
                                            ...
                                            //                    "Thông báo tại NGUỒN HÀNG TẬN GỐC.", "Đơn hàng " + o.ID + " đã được đặt cọc.", "");
                                            //            }
                                            //            catch { }
                                            //        }
                                            //    }
                                            ...
                                            if (setNoti.IsSentEmailAdmin == true)
                                            {
                                                ...
                                                if (admins.Count > 0)
                                                {
                                                    foreach (var admin in admins)
                                                    {
                                                        ...
                                                        {
                                                            PJUtils.SendMailGmail("cskh.thuonghai@gmail.com.vn.net", "jrbhnznozmlrmwvy", admin.Email,
                                                                "Thông báo tại NGUỒN HÀNG TẬN GỐC.", "Đơn hàng " + o.ID + " đã được đặt cọc thêm.", "");
                                                        }
                                                        catch { }
                                                    }
                                                }
                                        ...
                                        if (setNoti.IsSentEmailAdmin == true)
                                        {
                                            ...
                                            if (admins.Count > 0)
                                            {
                                                foreach (var admin in admins)
                                                {
                                                    ...
                                                    {
                                                        PJUtils.SendMailGmail("cskh.thuonghai@gmail.com.vn.net", "jrbhnznozmlrmwvy", admin.Email,
                                                            "Thông báo tại NGUỒN HÀNG TẬN GỐC.", "Đơn hàng " + item.MainOrderID + " đã yêu cầu giao hàng.", "");
                                                    }
                                                    catch { }
                                                }
                                            }
                            ...
                            if (moneyleft > 0)
                            {
                                ...
                                if (st == 1)
                                {
                                    ...
                                    if (setNoti != null)
                                    {
                                        ...
                                        //            {
                                        //                PJUtils.SendMailGmail("cskh.thuonghai@gmail.com.vn.net", "jrbhnznozmlrmwvy", admin.Email,
                                        //                    "Thông báo tại NGUỒN HÀNG TẬN GỐC.", "Đơn hàng " + o.ID + " đã được thanh toán.", "");
                                        //            }
                                        //            catch { }
                                        //        }
                                        //    }
