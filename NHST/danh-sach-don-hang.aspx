...
<asp:Content runat="server" ContentPlaceHolderID="ContentPlaceHolder1">
												...
												<div class="col s12">
														...
														<div class="row">
															...
															<div class="input-field col s12 l6">
																<asp:DropDownList runat="server" ID="ddlStatus">
																	...
																	<asp:ListItem Value="9" Text="Đã thanh toán"></asp:ListItem>
													...
													<div class="responsive-tb">
														<div class="pane-shadow filter-form" id="filter-form1" style="display: block">
															...
															<div class="extra-btn">
																<asp:Button ID="bttnAll" runat="server" CssClass="order-status btn-1" OnClick="btnAll_Click" />
																<asp:Button ID="btn0" runat="server" CssClass="order-status btn0" OnClick="btn0_Click" />
																<asp:Button ID="btn1" runat="server" CssClass="order-status btn1" OnClick="btn1_Click" />
																<asp:Button ID="btn2" runat="server" CssClass="order-status btn2" OnClick="btn2_Click" />
																<asp:Button ID="btn4" runat="server" CssClass="order-status btn4" OnClick="btn4_Click" />
																<asp:Button ID="btn5" runat="server" CssClass="order-status btn5" OnClick="btn5_Click" />
																<asp:Button ID="btn3" runat="server" CssClass="order-status btn3" OnClick="btn3_Click" />
																<asp:Button ID="btn6" runat="server" CssClass="order-status btn6" OnClick="btn6_Click" />
																<asp:Button ID="btn7" runat="server" CssClass="order-status btn7" OnClick="btn7_Click" />
																<asp:Button ID="btn8" runat="server" CssClass="order-status btn8" OnClick="btn8_Click" />
																<asp:Button ID="btn9" runat="server" CssClass="order-status btn9" OnClick="btn9_Click" />
																<asp:Button ID="btn11" runat="server" CssClass="order-status btn11" OnClick="btn11_Click" />
																<asp:Button ID="btn10" runat="server" CssClass="order-status btn10" OnClick="btn10_Click" />
																<asp:Button ID="btn12" runat="server" CssClass="order-status btn12" OnClick="btn12_Click" />
																<%--   </div>--%>
															</div>
														</div>
	...
	<asp:Button ID="btnDeleteOrder" runat="server" OnClick="btnRemoveOrder_Click" Style="display: none" />
	...
	<asp:Button Style="display: none" UseSubmitBehavior="false" ID="buttonExportStatistic" runat="server" OnClick="btnExcelStatistic_Click" />
	<script>
	...
	<script>
		...
		function exportStatistic(orderID, obj) {

			$("#<%=hdfOrderID.ClientID%>").val(orderID);
			$("#<%=buttonExportStatistic.ClientID%>").click();
		...
		function RemoveOrder(orderID, obj) {
			var c = confirm('Bạn muốn xóa đơn: ' + orderID);
			if (c == true) {
				obj.removeAttr("onclick");
				$("#<%=hdfOrderID.ClientID%>").val(orderID);
				$("#<%=btnDeleteOrder.ClientID%>").click();
			}
		}
