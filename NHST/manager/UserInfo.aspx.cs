...
namespace NHST.manager
{
    public partial class UserInfo : System.Web.UI.Page
    {
        ...
        public void loaddata()
        {
            ...
            if (id > 0)
            {
                ...
                {                   
                    ...
                    ddlFeeShip.SelectedValue = a.FeeShip.ToString();
        ...
        protected void btncreateuser_Click(object sender, EventArgs e)
        {
            ...
            int FeeShip = ddlFeeShip.SelectedValue.ToString().ToInt(1);           
            ...
            if (!string.IsNullOrEmpty(pass))
            {
                ...
                if (!string.IsNullOrEmpty(confirmpass))
                {
                    if (confirmpass == pass)
                    {
                        ...
                        AccountController.UpdateFeeShipVN(UID, FeeShip);
                        ...
                        string r = AccountInfoController.Update(UID, txtFirstName.Text.Trim(), txtLastName.Text.Trim(), txtEmail.Text, txtPhone.Text, txtAddress.Text.Trim(),
