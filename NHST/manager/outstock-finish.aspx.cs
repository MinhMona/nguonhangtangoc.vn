    ...
    public partial class outstock_finish : System.Web.UI.Page
    {
        ...
        protected void btncreateuser_Click(object sender, EventArgs e)
        {
            ...
            if (id > 0)
            {
                ...
                string Address = "";
                var user = AccountInfoController.GetByUserID(UID);
                if (user != null)
                    ...
                    if (mo.Count > 0)
                    {
                        foreach (var item in mo)
                        {
                            ...
                            if (m != null)
                            {
                                ...
                                //}
                                if (m.DateToShip == null)
                                {
                                    MainOrderController.UpdateDateToShip(m.ID, currentDate);
                                }
                                MainOrderController.UpdateStatusByID(m.ID, 11);
                            }
                        }
                    }
                }
                ...
                html += "       <div class=\"bill-row\">";
                html += "           <label class=\"row-name\">Địa chỉ người nhận: </label>";
