...
namespace NHST.manager
{
    public partial class Withdraw_List : System.Web.UI.Page
    {
        ...
        public void LoadData()
        {
            ...
            var la = WithdrawController.GetBySQL_DK(search, "", page, 20);
                                    ...
                                    if (setNoti.IsSendEmailUser == true)
                                    {
                                        try
                                        {
                                            ...
                                            PJUtils.SendMailGmail("cskh.thuonghai@gmail.com.vn.net", "jrbhnznozmlrmwvy", user_rut.Email,
                                                "Thông báo tại NGUỒN HÀNG TẬN GỐC.", html.ToString(), "");
                                        }
                                        catch { }
                                    }
                                }
                        ...
                        if (user_rut != null)
                        {
                            ...
                            if (setNoti != null)
                            {
                                ...
                                if (setNoti.IsSendEmailUser == true)
                                {
                                    try
                                    {
                                        PJUtils.SendMailGmail("cskh.thuonghai@gmail.com.vn.net", "jrbhnznozmlrmwvy", user_rut.Email, "Thông báo tại NGUỒN HÀNG TẬN GỐC.", "Admin đã hủy lệnh rút tiền của bạn.", "");
                                    }
                                    catch { }
                                }
                            }
