                ...
                <div class="list-table card-panel">
                    <div class="responsive-tb">
                        <div class="pane-shadow filter-form" id="filter-form1" style="display: block">
                            ...
                            <div class="extra-btn">
                                <asp:Button ID="bttnAll" UseSubmitBehavior="false" runat="server" CssClass="order-status btn-1" OnClick="btnAll_Click" />
                                <asp:Button ID="btn0" UseSubmitBehavior="false" runat="server" CssClass="order-status btn0" OnClick="btn0_Click" />
                                <asp:Button ID="btn1" UseSubmitBehavior="false" runat="server" CssClass="order-status btn1" OnClick="btn1_Click" />
                                <asp:Button ID="btn2" UseSubmitBehavior="false" runat="server" CssClass="order-status btn2" OnClick="btn2_Click" />
                                <asp:Button ID="btn4" UseSubmitBehavior="false" runat="server" CssClass="order-status btn4" OnClick="btn4_Click" />
                                <asp:Button ID="btn5" UseSubmitBehavior="false" runat="server" CssClass="order-status btn5" OnClick="btn5_Click" />
                                <asp:Button ID="btn3" UseSubmitBehavior="false" runat="server" CssClass="order-status btn3" OnClick="btn3_Click" />
                                <asp:Button ID="btn6" UseSubmitBehavior="false" runat="server" CssClass="order-status btn6" OnClick="btn6_Click" />
                                <asp:Button ID="btn7" UseSubmitBehavior="false" runat="server" CssClass="order-status btn7" OnClick="btn7_Click" />
                                <asp:Button ID="btn8" UseSubmitBehavior="false" runat="server" CssClass="order-status btn8" OnClick="btn8_Click" />
                                <asp:Button ID="btn9" UseSubmitBehavior="false" runat="server" CssClass="order-status btn9" OnClick="btn9_Click" />
                                <asp:Button ID="btn11" UseSubmitBehavior="false" runat="server" CssClass="order-status btn11" OnClick="btn11_Click" />                                
                                <asp:Button ID="btn10" UseSubmitBehavior="false" runat="server" CssClass="order-status btn10" OnClick="btn10_Click" />
                                <asp:Button ID="btn12" UseSubmitBehavior="false" runat="server" CssClass="order-status btn12" OnClick="btn12_Click" />
                                <%--   </div>--%>
                            </div>
                        </div>
