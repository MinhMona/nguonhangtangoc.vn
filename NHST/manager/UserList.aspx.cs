        ...
        public void pagingall(List<View_UserList> acs, int total)
        {
            ...
            if (total > 0)
            {
                ...
                for (int i = 0; i < acs.Count; i++)
                {
                    ...
                    string MienPhi = "<span class=\"badge red darken-2 white-text border-radius-2\">Không có</span>";
                    if (item.FeeShip == 2 )
                    {
                        MienPhi = "<span class=\"badge blue darken-2 white-text border-radius-2\">Được miễn</span>";
                    }    
