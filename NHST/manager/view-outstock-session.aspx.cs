                    ...
                    if (os != null)
                    {
                        ...
                        if (ops.Count > 0)
                        {
                            foreach (var o in ops)
                            {
                                ...
                                //htmlPrint.Append("           </tr>");
                                if (Convert.ToDouble(mo.IsPackedPrice) > 0)
                                {
                                    htmlPrint.Append("           <tr style=\"font-size: 15px;\">");
                                    htmlPrint.Append("               <td colspan=\"3\"><span style=\"font-weight: 500;\">Phí đóng gỗ</span></td>");
                                    htmlPrint.Append("               <td><span style=\"font-weight: 500;\">" + string.Format("{0:N0}", Convert.ToDouble(mo.IsPackedPrice)) + " vnđ</span></td>");
                                    htmlPrint.Append("           </tr>");
                                }
                                if (Convert.ToDouble(mo.IsCheckPriceSpecial) > 0)
                                {
                                    htmlPrint.Append("           <tr style=\"font-size: 15px;\">");
                                    htmlPrint.Append("               <td colspan=\"3\"><span style=\"font-weight: 500;\">Phí đặt biệt</span></td>");
                                    htmlPrint.Append("               <td><span style=\"font-weight: 500;\">" + string.Format("{0:N0}", Convert.ToDouble(mo.IsCheckPriceSpecial)) + " vnđ</span></td>");
                                    htmlPrint.Append("           </tr>");
                                }
                                htmlPrint.Append("           <tr style=\"font-size: 15px;\">");
                ...
                if (ots != null)
                {
                    ...
                    if (totalPay > 0)
                    {
                        ...
                        else
                        {
                            ...
                            html += "   <div class=\"top\">";
                            html += "       <div class=\"left\">";
                            html += "           <span class=\"company-info\">NGUỒN HÀNG TẬN GỐC</span>";
                            html += "          <span class=\"company-info\">Địa chỉ: Toà A1 An Bình, 232 Phạm Văn Đồng, Hà Nội</span>";
                            html += "       </div>";
                            html += "       <div class=\"right\">";
                            html += "           <span class=\"bill-num\">Mẫu số 01 - TT</span>";
                            html += "           <span class=\"bill-promulgate-date\">(Ban hành theo Thông tư số 133/2016/TT-BTC ngày 26/8/2016 của Bộ Tài chính)</span>";
