                ...
                else
                {
                    ...
                    if (mainorder != null)
                    {
                        ...
                        if (mo != null)
                        {
                            ...
                            int salerID = Convert.ToInt32(mo.SalerID);
                            ...
                            if (salerID > 0)
                            {
                                ...
                                if (sale != null)
                                {
                                    int UID = Convert.ToInt32(mo.UID);
                                    salerName = sale.Username;                                 
                                    var staff = StaffIncomeController.GetByMainOrderIDUID(mo.ID, salerID);
                                    if (staff != null)
                                    {
                                        if (staff.Status == 1)
                                        {
                                    ...
                                    else
                                    {
                                        ...
                                        if (top1.Count > 0)
                                        {
                                            ...
                                            if (d > 90)
                                            {
                                                double per = feebp * salepercentaf3m / 100;
                                                per = Math.Round(per, 0);
                                                StaffIncomeController.Insert(orderID, mo.TotalPriceVND, salepercentaf3m.ToString(), salerID, salerName, 6, 1, per.ToString(), false,
                                                CreatedDate, CreatedDate, username_current);
                                            }
                                            else
                                            {
                                                double per = feebp * salepercent / 100;
                                                per = Math.Round(per, 0);
                                                StaffIncomeController.Insert(orderID, mo.TotalPriceVND, salepercent.ToString(), salerID, salerName, 6, 1, per.ToString(), false,
                                                CreatedDate, CreatedDate, username_current);
                                            }
                                        }
                                    }
                            ...
                            if (dathangID > 0)
                            {
                                ...
                                if (dathang != null)
                                {
                                    ...
                                    if (!string.IsNullOrEmpty(mo.FeeShipCNReal))
                                        FeeShipCNReal = Math.Round(Convert.ToDouble(mo.FeeShipCNReal), 0);
                                    ...
                                    if (staff != null)
                                    {
                                        ...
                                        {                  
                                            if (totalRealPrice > 0)
                                            {
                                                double totalpriceloi = totalPrice - totalRealPrice - FeeShipCNReal;
