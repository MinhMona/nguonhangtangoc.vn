...
namespace NHST.manager
{
    public partial class ComplainList1 : System.Web.UI.Page
    {
        protected void Page_Load(object sender, EventArgs e)
        {
            if (!IsPostBack)
            {
                ...
                else
                {
                    ...
                    if (ac.RoleID != 0 && ac.RoleID != 2 && ac.RoleID != 9 && ac.RoleID != 3)
                        Response.Redirect("/");
                    LoadData();
                    loadFilter();
                }
        ...
        private void LoadData()
        {
            ...
            var total = ComplainController.GetTotal(search, fd, td, status, nvdh, nvcs, Convert.ToInt32(ac.RoleID), Convert.ToInt32(ac.ID));
            var la = ComplainController.GetAllBySQL(search, page, 20, fd, td, status, nvdh, nvcs, Convert.ToInt32(ac.RoleID), Convert.ToInt32(ac.ID));
            pagingall(la, total);
        }
        ...
        public static string UpdateStaff(int OrderID, int StaffID, int Type)
        {
            ...
            if (obj_user != null)
            {
                if (obj_user.RoleID == 0 || obj_user.RoleID == 2)
                {
                    if (Type == 2)
                    {
                        var com = ComplainController.GetByID(OrderID);
                        if (com != null)
                        {
                            ComplainController.UpdateDathangID(OrderID, StaffID);
        ...
        protected void btnUpdate_Click(object sender, EventArgs e)
        {
                ...
                if (ac.RoleID == 0 || ac.RoleID == 2 || ac.RoleID == 9)
                {
                    if (ID > 0)
                    {
                        ...
                        if (com != null)
                        {
                            ...
                            ComplainController.UpdateAmount(com.ID, txtAmountVND.Text.ToString(), DateTime.Now, username_current, txtComplainText.Text.ToString());
                            ...
                            if (status != 3)
                            {
                                if (status != statusold)
                                {
                                    ...
                                    MainOrderController.UpdateStatusByID(Convert.ToInt32(com.OrderID), 10);
                                    if (status == 0)
                                    {
                                        ...
                                        if (setNoti != null)
                                        {
                                            if (setNoti.IsSentNotiUser == true)
                                            {
                                                ...
                                                AccountController.GetByID(Convert.ToInt32(u.ID)).Username, Convert.ToInt32(com.OrderID), "BQT Nguồn Hàng Tận Gốc đã hủy khiếu nại đơn hàng: " + com.OrderID + " của bạn.", 5, currentDate, ac.Username, false);
                                            }
                                        }
                                    }
                                    else if (status == 4)
                            ...
                            else
                            {
                                if (status != statusold)
                                {                                   
                                    var mo = MainOrderController.GetAllByID(Convert.ToInt32(com.OrderID));
                                    if (mo != null)
                                    {
                                        MainOrderController.UpdateStatusByID(Convert.ToInt32(com.OrderID), 10);
                                        if (mo.CompleteDate == null)
                                        {
                                            MainOrderController.UpdateCompleteDate(Convert.ToInt32(com.OrderID), DateTime.Now);
                                        }    
                                    }    
                                    ComplainController.Update(com.ID, txtAmountVND.Text.ToString(), status, DateTime.Now, username_current, txtComplainText.Text.ToString());
                                }                                        
            ...
            //                                "Thông báo tại NGUỒN HÀNG TẬN GỐC.",
            ...
            //                                u.Email,
            //                                "Thông báo tại NGUỒN HÀNG TẬN GỐC.", "Admin đã hủy khiếu nại đơn hàng: "
            //                                + com.OrderID + "  của bạn.", "");
            //                        }
            //                        catch { }
            //                    }
        ...
        protected void btnSaveAdd_Click(object sender, EventArgs e)
        {
            ...
            if (ac != null)
            {
                if (ac.RoleID == 0 || ac.RoleID == 2 || ac.RoleID == 9)
                {
                    ...
                    double Amount = Convert.ToInt32(txtMoney.Text);
                    ...
                    if (shops != null)
                    {
                        ...
                        string kq = ComplainController.Insert(UID, MainOrderID, Amount.ToString(), link, Content, 1, DateTime.Now, Username, Type, Convert.ToInt32(shops.DathangID));
