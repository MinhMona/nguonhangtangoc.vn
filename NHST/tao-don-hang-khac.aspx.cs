    ...
    public partial class tao_don_hang_khac1 : System.Web.UI.Page
    {
        ...
        protected void btncreateuser_Click(object sender, EventArgs e)
        {
            ...
            if (obj_user != null)
            {
                ...
                var adminfeebuypro = FeeBuyProController.GetAllShippingType(Convert.ToInt32(ddlShipping.SelectedValue));
                ...
                if (idkq > 0)
                {
                    ...
                    MainOrderController.UpdateFromPlace(idkq, UID, 1, Convert.ToInt32(ddlShipping.SelectedValue));
