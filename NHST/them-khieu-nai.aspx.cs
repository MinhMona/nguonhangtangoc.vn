        ...
        protected void btnSend_Click(object sender, EventArgs e)
        {
            ...
            if (u != null)
            {
                ...
                if (shops != null)
                {
                    ...
                    string kq = ComplainController.Insert(UID, orderid, "0", link, txtNote.Text, 1, DateTime.Now, username, status, Convert.ToInt32(shops.DathangID));
                    if (kq.ToInt(0) > 0)
                    {
                        ...
                        if (o != null)
                        {
                            ...
                            if (setNoti != null)
                            {
                                ...
                                //                    "Thông báo tại NGUỒN HÀNG TẬN GỐC.", "Đã có khiếu nại mới cho đơn hàng #" + orderid + ". CLick vào để xem", "");
                                //            }
                                //            catch { }
                                //        }
                                //    }
