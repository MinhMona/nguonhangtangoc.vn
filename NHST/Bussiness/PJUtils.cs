...
namespace NHST.Bussiness
{
    public class PJUtils
    {
        ...
        public static string IntToStringStatusContact(int status)
        {
            if (status == 1)
                return "<span class=\"white-text badge red darken-2\">Yêu cầu mới</span>";
            else
                return "<span class=\"white-text badge blue darken-2\">Đã xử lý</span>";
        }
        ...
        public static string IntToStringStatusSmallPackageNew(int status)
        {
            if (status == 0)
                ...
                return "<span class=\"badge teal darken-2 white-text border-radius-2\">Đã thanh toán</span>";
            else
        ...
        public static string IntToStringStatusSmallPackageWithBG45(int status)
        {
            if (status == 0)
                ...
                return "<span class=\"badge border-radius-2 darken-2 teal white-text\">Đang về kho đích</span>";
            else if (status == 3)
