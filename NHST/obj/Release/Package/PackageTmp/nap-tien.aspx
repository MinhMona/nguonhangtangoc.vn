                                                ...
                                                <div class="col s12">
                                                    ...
                                                    <div class="donate-guide">
                                                        ...
                                                        <strong>thanh toán</strong> một khoản tiền <strong>đặt
                                                            cọc trước cho NGUỒN HÀNG TẬN GỐC </strong>để chúng tôi thực hiện
                                                        ...
                                                        <p class="pl-3">
                                                            ...
                                                            website đặt hàng Trung Quốc, số tiền này <strong>NGUỒN HÀNG TẬN GỐC thu hộ cho </strong>
                                                            nhà cung cấp.
                                                        </p>
                                                        <p class="pl-3">
                                                            + <strong>Phí dịch vụ</strong>: là phí khách hàng
                                                        trả cho <strong>NGUỒN HÀNG TẬN GỐC </strong>để tiến hành thu mua theo đơn hàng đã đặt.
                                                        </p>
                                                        ...
                                                        <p class="pl-3 fix" style="text-decoration: underline;"><strong>VĂN PHÒNG MIỀN BẮC</strong></p>
                                                        <p class="pl-3 fix"><strong>Tòa A1 An Bình city , 232 Phạm Văn Đồng, Hà Nội</strong></p>
                                                        <%--<p class="pl-3 fix"><strong>2. Đường Hồ Tùng Mậu - Nam Từ Liêm - Hà Nội</strong></p>--%>
                                                        <p class="pl-3 fix"><strong>Hotline:    090.690.1688</strong></p>
                                                        <p class="pl-3 fix"><strong>Hotline2:   086.538.3382</strong></p>
                                                        <p class="pl-3 fix"><strong>Kho:        098.414.9296</strong></p>
                                                        ...
                                                        <p class="pl-3 fix"><strong>Hotline:    096.650.7999</strong></p>
